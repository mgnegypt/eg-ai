...
web-ui 是 MGN AI 项目的嵌入式 Web 前端，基于 React Router 7 的单页应用（SPA）。构建产物通过 `copy.ts` 脚本复制到 `../web/src/main/resources/static` 目录，由 Kotlin 后端的 Ktor 服务器提供静态文件服务。
...
|----------------|------------|---------|
| `MessageRole` | `MessageRole` | `ai/src/main/java/com/mgn/ai/ai/core/MessageRole.kt` |
| `TokenUsage` | `Usage` | `ai/src/main/java/com/mgn/ai/ai/core/Usage.kt` |
| `UIMessagePart` | `UIMessagePart` | `ai/src/main/java/com/mgn/ai/ai/ui/Message.kt` |
| `UIMessage` | `UIMessage` | `ai/src/main/java/com/mgn/ai/ai/ui/Message.kt` |
| `MessageNode` | `MessageNode` | `app/src/main/java/com/mgn/ai/data/model/Conversation.kt` |
| `Conversation` | `Conversation` | `app/src/main/java/com/mgn/ai/data/model/Conversation.kt` |
| `ConversationDto` | `ConversationDto` | `app/src/main/java/com/mgn/ai/web/dto/WebDto.kt` |
| `Settings` | `Settings` | `app/src/main/java/com/mgn/ai/data/datastore/PreferencesStore.kt` |
