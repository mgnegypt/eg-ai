/**
 * Display settings
 * @see app/src/main/java/com/mgn/ai/data/datastore/PreferencesStore.kt - DisplaySetting
 */
 ...
 * @see app/src/main/java/com/mgn/ai/data/datastore/PreferencesStore.kt - Settings
 */
