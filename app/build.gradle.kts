...
android {
    ...
    lint {
        // Baseline of pre-existing upstream issues (LocalContext.getString in
        // callbacks). CI fails on any NEW lint error outside this baseline.
...
// MGN AI release naming: mgn-ai-v<VERSION>-<ABI>-release.apk (dynamic per versionName)
androidComponents {
    onVariants { variant ->
        variant.outputs.forEach { output ->
            ...
            output.outputFileName.set("mgn-ai-v$ver-$abi-release.apk")
        }
    }
}
