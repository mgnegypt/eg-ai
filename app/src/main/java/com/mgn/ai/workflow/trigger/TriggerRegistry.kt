package com.mgn.ai.workflow.trigger
...
import com.mgn.ai.workflow.model.TriggerSpec
...
class TriggerRegistry(
    ...
    suspend fun resync(enabled: List<WorkflowDefinition>): Unit = syncMutex.withLock {
        ...
        val foregroundConsumerCount = enabled.count { wf ->
            wf.trigger is com.mgn.ai.workflow.model.TriggerSpec.AppLaunched
                || wf.trigger is com.mgn.ai.workflow.model.TriggerSpec.AppClosed
                || wf.conditions.any {
                    it is com.mgn.ai.workflow.model.ConditionSpec.ForegroundAppIs
                        || it is com.mgn.ai.workflow.model.ConditionSpec.ForegroundAppIn
                }
        }
        com.mgn.ai.workflow.trigger.AppForegroundDispatcher
