package com.mgn.ai.workflow.condition
...
import com.mgn.ai.workflow.model.WorkflowContext
...
class ContextProvider(private val context: Context) {
    ...
    fun snapshot(needsLocation: Boolean = false): WorkflowContext {
        ...
        val foregroundPackage = com.mgn.ai.workflow.trigger.AppForegroundLastKnown.value
