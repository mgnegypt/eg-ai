...
import com.mgn.ai.CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID
import com.mgn.ai.R
...
class ChatGenerationForegroundService : Service() {
    companion object {
        private const val ACTION_ACQUIRE = "com.mgn.ai.action.CHAT_GENERATION_ACQUIRE"
        private const val ACTION_RELEASE = "com.mgn.ai.action.CHAT_GENERATION_RELEASE"
    ...
    private fun buildNotification(conversationId: String) =
        NotificationCompat.Builder(this, CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_stat_mgnai)
