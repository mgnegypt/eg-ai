...
private const val API_URL = "https://api.github.com/repos/mgnegypt/eg-ai/releases/latest"
...
class UpdateChecker(
                ...
                data = try {
                    val response = client.newCall(
                        Request.Builder()
                            ...
                            .addHeader(
                                "User-Agent",
                                "MGN-AI ${BuildConfig.VERSION_NAME} #${BuildConfig.VERSION_CODE}"
                            )
    ...
    fun downloadUpdate(context: Context, download: UpdateDownload) {
        runCatching {
            ...
            Toast.makeText(context, context.getString(R.string.update_card_check_failed), Toast.LENGTH_SHORT).show()
...
private data class GithubRelease(
    ...
    fun toUpdateInfo(): UpdateInfo {
        ...
        return UpdateInfo(
            version = tag_name.trimStart('v', 'V'),
