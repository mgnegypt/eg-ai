...
import com.mgn.ai.data.datastore.isNotConfigured
...
import com.mgn.ai.ui.hooks.rememberColorMode
import com.mgn.ai.ui.locale.AppLanguage
import com.mgn.ai.ui.locale.findActivity
import com.mgn.ai.ui.locale.getAppLanguageTag
import com.mgn.ai.ui.locale.setAppLanguageTag
import com.mgn.ai.ui.theme.ColorMode
        ...
        LazyColumn(
                    ...
                    item(
                        ...
                        trailingContent = {
                            ...
                            var appLanguage by remember {
                                mutableStateOf(context.getAppLanguageTag())
                            }
                            Select(
                                options = AppLanguage.ALL,
                                selectedOption = appLanguage,
                                onOptionSelected = {
                                    context.setAppLanguageTag(it)
                                    appLanguage = it
                                ...
                                optionToString = { tag ->
                                    when (tag) {
                                        ...
                                        else -> stringResource(R.string.setting_page_language_system)
                                    }
                                },
                                modifier = Modifier.width(150.dp)
                            )
            ...
            item("aboutSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = {
                            context.openUrl("https://github.com/mgnegypt/eg-ai")
                        },
