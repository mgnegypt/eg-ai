...
import com.mgn.ai.R
import com.mgn.ai.data.ai.mcp.McpCommonOptions
import com.mgn.ai.data.ai.mcp.McpManager
import com.mgn.ai.data.ai.mcp.McpServerConfig
import com.mgn.ai.data.ai.mcp.McpStatus
import com.mgn.ai.data.ai.mcp.McpTool
import com.mgn.ai.ui.components.nav.BackButton
import com.mgn.ai.ui.components.ui.FormItem
import com.mgn.ai.ui.components.ui.Switch
import com.mgn.ai.ui.components.ui.SwitchSize
import com.mgn.ai.ui.components.ui.Tag
import com.mgn.ai.ui.components.ui.TagType
import com.mgn.ai.ui.hooks.EditState
import com.mgn.ai.ui.hooks.EditStateContent
import com.mgn.ai.ui.hooks.useEditState
import com.mgn.ai.ui.theme.CustomColors
import com.mgn.ai.ui.theme.extendColors
import com.mgn.ai.utils.writeClipboardText
            ...
            Row(
                ...
                Column(
                    ...
                    if (status == McpStatus.Authorizing) {
                        Text(
                            text = "Authorizing. Please complete in the browser…",
                            style = MaterialTheme.typography.labelSmall,
                        )
                        TextButton(
