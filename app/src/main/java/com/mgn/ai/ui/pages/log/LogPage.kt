package com.mgn.ai.ui.pages.log
...
import com.mgn.ai.common.android.LogEntry
...
private fun RequestLogCard(log: LogEntry.RequestLog, onClick: () -> Unit) {
    ...
    val dateFormat = remember(displayLocale) { SimpleDateFormat("HH:mm:ss", displayLocale) }
...
private fun RequestLogDetail(log: LogEntry.RequestLog) {
    val displayLocale = LocalConfiguration.current.locales[0]
    val dateFormat = remember(displayLocale) { SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS", displayLocale) }
