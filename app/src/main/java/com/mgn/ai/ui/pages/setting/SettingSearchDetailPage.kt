...
import com.mgn.ai.highlight.LocalCodeHighlighter
import com.mgn.ai.R
import com.mgn.ai.ui.components.nav.BackButton
import com.mgn.ai.ui.components.richtext.HighlightCodeVisualTransformation
...
import com.mgn.ai.search.DoubaoSearchMode
import com.mgn.ai.search.SearchCommonOptions
import com.mgn.ai.search.SearchResult
...
private fun SearchServiceOptionsEditor(
    ...
    when (options) {
        ...
        is SearchServiceOptions.MgnAiOptions -> {
            MgnAiOptions(options) { onUpdateOptions(it) }
        }
...
@Composable
internal fun MgnAiOptions(
    options: SearchServiceOptions.MgnAiOptions,
    onUpdateOptions: (SearchServiceOptions.MgnAiOptions) -> Unit
) {
    FormItem(
        label = {
            Text(stringResource(R.string.search_detail_api_key))
