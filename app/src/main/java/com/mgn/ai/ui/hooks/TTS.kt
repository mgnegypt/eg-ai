...
import com.mgn.ai.tts.model.PlaybackState
...
import com.mgn.ai.tts.controller.TtsController
...
private class CustomTtsStateImpl(
    ...
    private val controller by lazy { com.mgn.ai.tts.controller.TtsController(context, ttsManager) }
