package com.mgn.ai.ui.pages.setting.components
...
import com.mgn.ai.ui.components.ui.OutlinedNumberInput
import com.mgn.ai.ui.components.ui.SelectTextField
        ...
        FormItem(
            ...
            SelectTextField(
                value = when (setting) {
                    ...
                    is TTSProviderSetting.Volcengine -> "Volcano Engine"
                },
                options = providers,
                readOnly = true,
                ...
                optionToString = { providerClass ->
                    when (providerClass) {
                        ...
                        TTSProviderSetting.Volcengine::class -> "Volcano Engine"
...
private fun StepTTSConfiguration(
    ...
    FormItem(
        label = { Text(stringResource(R.string.setting_tts_page_api_key)) },
        description = { Text("Get your API key from the StepFun official site: platform.stepfun.com/interface-key") }
    ) {
        OutlinedTextField(
            value = setting.apiKey,
            onValueChange = { newApiKey ->
            ...
            modifier = Modifier.fillMaxWidth(),
            placeholder = { Text("Get your API key from the StepFun official site") },
        )
    }
    ...
    val voices = listOf(
        "elegantgentle-female" to "Graceful and gentle (elegantgentle-female)",
        "livelybreezy-female" to "Lively and brisk (livelybreezy-female)",
        "energeticconfident-female" to "Energetic and confident (energeticconfident-female)",
        ...
        "qingchunshaonv" to "Pure young girl (qingchunshaonv)",
        ...
        "lengyanyujie" to "Cool beauty (lengyanyujie)",
        "shuangkuaijiejie" to "Cheerful sister (shuangkuaijiejie)",
        "wenjingxuejie" to "Quiet senior (wenjingxuejie)",
        "linjiajiejie" to "Girl next door (linjiajiejie)",
        "linjiameimei" to "Sister next door (linjiameimei)",
        ...
        "shuangkuainansheng" to "Hearty male voice (shuangkuainansheng)",
        ...
        "wenrougongzi" to "Gentle young man (wenrougongzi)",
    ...
    FormItem(
        ...
        description = { Text("Audio encoding format (note: StepFun API field name is camelCase)") }
    ) {
        SelectTextField(
    ...
    FormItem(
        label = { Text(stringResource(R.string.setting_tts_page_speed)) },
        description = { Text("Speech speed (0.5 - 2.0, 1.0 is normal)") }
    ) {
        OutlinedNumberInput(
            value = setting.speed,
            onValueChange = { newSpeed ->
    ...
    FormItem(
        ...
        description = { Text("Global context instruction, only applies to stepaudio-2.5-tts (up to 200 characters, leave empty to skip)") }
    ) {
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            placeholder = { Text("For example: gentle tone, slower pace") },
            minLines = 2,
            maxLines = 4,
        )
    }
...
private fun VolcengineTTSConfiguration(
    ...
    FormItem(
        label = { Text("API Key") },
        description = { Text("Enter the API Key from the Doubao Voice console, not the Volcano Ark console API Key.") }
    ) {
        OutlinedTextField(
            value = setting.apiKey,
    ...
    FormItem(
        ...
        description = { Text("Must match your enabled service and voice. Defaults to seed-tts-2.0.") }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = { Text("Voice ID") },
        description = { Text("Enter the voice ID from the console. Uses the VV voice by default.") }
    ) {
        OutlinedTextField(
