...
import com.mgn.ai.data.db.DatabaseMigrationTracker
import com.mgn.ai.data.db.MigrationState
import com.mgn.ai.data.event.AppEvent
import com.mgn.ai.data.event.AppEventBus
import com.mgn.ai.ui.activity.SafeModeActivity
import com.mgn.ai.ui.components.ui.TTSController
import com.mgn.ai.ui.context.LocalASRState
import com.mgn.ai.ui.context.LocalNavController
import com.mgn.ai.ui.context.LocalSettings
import com.mgn.ai.ui.context.LocalSharedTransitionScope
import com.mgn.ai.ui.context.LocalTTSState
import com.mgn.ai.ui.context.LocalToaster
import com.mgn.ai.ui.context.Navigator
import com.mgn.ai.ui.hooks.readBooleanPreference
import com.mgn.ai.ui.hooks.readStringPreference
import com.mgn.ai.ui.locale.applyAppLocale
import com.mgn.ai.ui.hooks.rememberCustomAsrState
import com.mgn.ai.ui.hooks.rememberCustomTtsState
import com.mgn.ai.ui.pages.assistant.AssistantPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantBasicPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantDetailPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantExtensionsPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantLocalToolPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantMcpPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantMemoryPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantPromptPage
import com.mgn.ai.ui.pages.assistant.detail.AssistantRequestPage
import com.mgn.ai.ui.pages.backup.BackupPage
import com.mgn.ai.ui.pages.chat.ChatPage
import com.mgn.ai.ui.pages.debug.DebugPage
import com.mgn.ai.ui.pages.extensions.ExtensionsPage
import com.mgn.ai.ui.pages.extensions.PromptPage
import com.mgn.ai.ui.pages.extensions.QuickMessagesPage
import com.mgn.ai.ui.pages.extensions.skills.SkillDetailPage
import com.mgn.ai.ui.pages.extensions.skills.SkillsPage
import com.mgn.ai.ui.pages.extensions.workspace.WorkspacePage
import com.mgn.ai.ui.pages.extensions.workspace.WorkspaceDetailPage
import com.mgn.ai.ui.pages.extensions.workspace.WorkspaceFileEditorPage
import com.mgn.ai.ui.pages.extensions.workspace.WorkspaceTerminalPage
import com.mgn.ai.workspace.WorkspaceStorageArea
import com.mgn.ai.ui.pages.favorite.FavoritePage
import com.mgn.ai.ui.pages.history.HistoryPage
import com.mgn.ai.ui.pages.imggen.ImageGenPage
import com.mgn.ai.ui.pages.log.LogPage
import com.mgn.ai.ui.pages.search.SearchPage
import com.mgn.ai.ui.pages.setting.SettingAboutPage
import com.mgn.ai.ui.pages.setting.SettingPreferencesPage
import com.mgn.ai.ui.pages.setting.SettingPreferencesThemePage
import com.mgn.ai.ui.pages.setting.SettingPreferencesNotificationPage
import com.mgn.ai.ui.pages.setting.SettingPreferencesGeneralPage
import com.mgn.ai.ui.pages.setting.SettingPreferencesNetworkPage
import com.mgn.ai.ui.pages.setting.SettingPreferencesUIPage
...
import com.mgn.ai.ui.pages.setting.SettingProviderDetailPage
import com.mgn.ai.ui.pages.setting.SettingProviderPage
import com.mgn.ai.ui.pages.setting.SettingSearchDetailPage
import com.mgn.ai.ui.pages.setting.SettingSearchPage
import com.mgn.ai.ui.pages.setting.SettingSpeechPage
import com.mgn.ai.ui.pages.setting.SettingWebPage
import com.mgn.ai.ui.pages.share.handler.ShareHandlerPage
import com.mgn.ai.ui.pages.stats.StatsPage
import com.mgn.ai.ui.pages.translator.TranslatorPage
import com.mgn.ai.ui.pages.webview.WebViewPage
import com.mgn.ai.ui.theme.LocalDarkMode
import com.mgn.ai.ui.theme.MgnAiTheme
import com.mgn.ai.utils.CrashHandler
import com.mgn.ai.utils.openUsageAccessSettings
...
private const val ACTION_TRANSLATE = "com.mgn.ai.action.TRANSLATE"
