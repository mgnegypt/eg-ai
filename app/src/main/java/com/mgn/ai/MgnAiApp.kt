...
import com.mgn.ai.di.appModule
import com.mgn.ai.di.dataSourceModule
import com.mgn.ai.di.repositoryModule
import com.mgn.ai.di.viewModelModule
...
import com.mgn.ai.data.sync.RestoreFailedException
import com.mgn.ai.utils.JsonInstant
import com.mgn.ai.service.WebServerService
import com.mgn.ai.utils.CrashHandler
import com.mgn.ai.utils.DatabaseUtil
import com.mgn.ai.data.repository.WorkspaceRepository
import com.mgn.ai.ui.hooks.migrateLegacyPreferences
...
private const val TAG = "MgnAiApp"

const val CHAT_COMPLETED_NOTIFICATION_CHANNEL_ID = "chat_completed"
const val CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID = "chat_live_update"
const val WEB_SERVER_NOTIFICATION_CHANNEL_ID = "web_server"

class MgnAiApp : Application() {
    ...
    override fun onCreate() {
        ...
        try {
            val restored = runBlocking(Dispatchers.IO) {
                BackupManager.applyPendingRestore(this@MgnAiApp, JsonInstant)
            }
            if (restored) {
            ...
            Toast.makeText(this, "Backup restore failed. Your original data has been kept. Please re-import the backup.", Toast.LENGTH_LONG).show()
        }
        startKoin {
            androidLogger()
            androidContext(this@MgnAiApp)
            workManagerFactory()
        ...
        get<AppScope>().launch {
            runCatching {
                ...
                if (settings.webServerEnabled) {
                    ...
                    val intent = Intent(this@MgnAiApp, WebServerService::class.java).apply {
