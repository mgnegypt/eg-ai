...
class OAuthLoopbackCallbackServer(
    ...
    private suspend fun openSession(
        ...
        require(expectedState.isNotBlank()) { "OAuth state must not be empty" }
        ...
        return lifecycleMutex.withLock {
            ...
            check(callbacks.putIfAbsent(expectedState, registration) == null) {
                "An authorization session with this OAuth state is already pending"
            }
            try {
    ...
    private fun successHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can close this tab and return to MGN AI.",
        ),
    )
    ...
    private fun errorHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Close this tab and try again from MGN AI.",
        ),
    )
    ...
    private fun invalidCallbackHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Return to MGN AI and start the authorization again.",
        ),
    )
    ...
    private fun callbackAlreadyHandledHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can safely close this tab and return to MGN AI.",
        ),
    )
